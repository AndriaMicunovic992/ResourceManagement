...
export default function StatCard({ icon, value, label, color, info, bar }) {
  return (
    <div className="bg-white rounded-2xl border border-border-light shadow-card px-4 py-3.5">
      <div className="flex items-center gap-2 text-[15px] font-semibold text-text-mid">
        <span
      ...
      <div className="mt-2 text-[32px] font-extrabold tracking-tight leading-none" style={{ color }}>{value}</div>
