        ...
        <div className="w-[270px] shrink-0 px-3 py-2 flex items-center gap-2">
          ...
          <div className="flex-1 min-w-0">
            <button
              ...
              className="block text-[15px] font-semibold text-text truncate bg-transparent border-0 p-0 cursor-pointer hover:text-primary hover:underline text-left"
              title="Open profile"
            >
              {resource.name}
            </button>
            <div className="text-[12px] font-mono" style={{ color: avgColor }}>
              {avgPct}% avg
